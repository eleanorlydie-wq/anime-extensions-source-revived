...
class YoMovies :
    ...
    private fun extractVideosFromIframe(iframeUrl: String, name: String): List<Video> = when {
    ...
    private class EnglishSeriesFilter :
        UriPartFilter(
            "English Series",
            arrayOf(
                Pair("<select>", ""),
    ...
    // on /
    private class HindiSeriesFilter :
        UriPartFilter(
            "Hindi Series",
            arrayOf(
                Pair("<select>", ""),
    ...
    // on /
    private class ExtraMoviesFilter :
        UriPartFilter(
            "ExtraMovies",
            arrayOf(
                Pair("<select>", ""),
