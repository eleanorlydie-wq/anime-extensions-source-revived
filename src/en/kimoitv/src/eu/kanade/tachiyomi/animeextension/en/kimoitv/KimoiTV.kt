...
class KimoiTV : ParsedAnimeHttpSource() {
    ...
    private class TVSeriesGenreFilter :
        UriPartFilter(
            "TV Series",
            arrayOf(
                Pair("<select>", ""),
    ...
    private class MovieGenreFilter :
        UriPartFilter(
            "Movies",
            arrayOf(
                Pair("<select>", ""),
    ...
    private class DramaGenreFilter :
        UriPartFilter(
            "Drama",
            arrayOf(
                Pair("<select>", ""),
    ...
    private class AnimeGenreFilter :
        UriPartFilter(
            "Anime",
            arrayOf(
                Pair("<select>", ""),
    ...
    private class TVSeriesAZFilter :
        UriPartFilter(
            "TV Series",
            arrayOf(
                Pair("<select>", ""),
